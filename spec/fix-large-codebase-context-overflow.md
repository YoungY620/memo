...
- Each file path is an absolute path like `/Users/moonshot/dev/working/very-long-project-name/src/components/deeply/nested/path/to/file.tsx`
...
```
Changed files:
- /Users/moonshot/dev/working/my-project/src/components/Button.tsx
- /Users/moonshot/dev/working/my-project/src/components/Input.tsx
- /Users/moonshot/dev/working/my-project/src/utils/helpers.ts
```

**After:**
```
Working directory: /Users/moonshot/dev/working/my-project
