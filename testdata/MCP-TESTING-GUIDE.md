...
# 或者使用 npx 运行
echo '{"jsonrpc":"2.0","id":1,"method":"tools/list"}' | npx --yes @anthropic/mcp-inspector node mcp/dist/index.js --root-path ./testdata/django-repo
```
...
kimi mcp add --transport stdio lightkeeper -- \
  node /Users/moonshot/dev/working/kimi-sdk-agent-indexer/mcp/dist/index.js \
  --root-path /Users/moonshot/dev/working/kimi-sdk-agent-indexer/testdata/django-repo
...
```json
{
  "mcpServers": {
    "lightkeeper": {
      "command": "node",
      "args": [
        "/Users/moonshot/dev/working/kimi-sdk-agent-indexer/mcp/dist/index.js",
        "--root-path",
        "/Users/moonshot/dev/working/kimi-sdk-agent-indexer/testdata/django-repo"
      ]
    }
  }
}
...
重启 Claude Desktop 后，在工具列表中应该能看到 `lightkeeper` 的三个工具。
